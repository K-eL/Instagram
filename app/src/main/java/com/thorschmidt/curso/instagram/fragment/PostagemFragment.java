...
import com.thorschmidt.curso.instagram.activity.FiltroActivity;
...
public class PostagemFragment extends Fragment {
    ...
    private void setListeners() {
        //Adiciona evento de clique no boṭo da camera
        ...
        //Adiciona evento de clique no boṭo da galeria
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if( resultCode == getActivity().RESULT_OK ){
            ...
            try {
                ...
                //Valida tipo de sele̤̣o da imagem
                switch ( requestCode ){
                    case SELECAO_CAMERA :
                ...
                if( imagem != null ){
                    ...
                    //Envia imagem escolhida para aplica̤̣o de filtro
