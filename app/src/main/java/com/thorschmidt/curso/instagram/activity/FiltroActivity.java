...
import com.thorschmidt.curso.instagram.adapter.AdapterMiniaturas;
...
public class FiltroActivity extends AppCompatActivity {
    ...
    // Esse bloco static é executado toda vez que a classe for carregada.
    static
    {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recuperarImagemEscolhida();

    }

    private void recuperarImagemEscolhida() {
