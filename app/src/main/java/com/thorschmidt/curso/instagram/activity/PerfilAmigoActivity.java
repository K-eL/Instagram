...
import com.thorschmidt.curso.instagram.adapter.AdapterGrid;
import com.thorschmidt.curso.instagram.model.Postagem;
...
public class PerfilAmigoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Carrega as fotos das postagens de um usuÃ¡rio
    ...
    private void carregarFotosPostagem(){
        ...
        postagensUsuarioRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                int tamanhoGrid = getResources().getDisplayMetrics().widthPixels; // pega o tamanho da tela do usuário
        ...
        usuarioLogadoRef.addListenerForSingleValueEvent(
                new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        //Recupera dados de usuÃ¡rio logado
                        usuarioLogado = dataSnapshot.getValue( Usuario.class );

                        /* Verifica se usuÃ¡rio jÃ¡ estÃ¡ seguindo
                           amigo selecionado
                         */
    ...
    private void verificaSegueUsuarioAmigo(){
        ...
        // one time only executed listener
    ...
    private void habilitarBotaoSeguir( boolean segueUsuario ){
        ...
        if ( segueUsuario ){
            ...
            //Adiciona evento para seguir usuÃ¡rio
